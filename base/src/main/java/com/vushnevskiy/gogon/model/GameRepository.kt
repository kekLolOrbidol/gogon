...
abstract class GameRepository(
  ...
  fun commitGameChanges(gameData: PlayGameData.GameData) {
  ...
  protected fun saveToCache(gameData: PlayGameData.GameData): Boolean {
  ...
  protected abstract fun publishRemoteGameState(gameData: PlayGameData.GameData): Boolean
  ...
  private fun fireGameChanged(gameData: PlayGameData.GameData) {
    for (listener in gameChangelisteners) {
      listener.gameChanged(gameData)
    }
  }

  protected fun fireGameSelected(gameData: PlayGameData.GameData?) {
  ...
  fun createNewLocalGame(): PlayGameData.GameData {
...
interface GameChangeListener {
  fun gameChanged(gameData: PlayGameData.GameData)
}

interface GameSelectionListener {
  fun gameSelected(gameData: PlayGameData.GameData?)
}
